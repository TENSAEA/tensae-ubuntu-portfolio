const projects = [
  {
    ...
    description:
      "A comprehensive task management application built with the MERN stack. Features include task creation, assignment, tracking, and team collaboration tools.",
    technologies: [
      "React",
      "Node.js",
      "Express",
  ...
  },
  {
    ...
    description:
      "A full-featured e-commerce platform built with PHP and React, featuring GraphQL integration. Includes product catalog, user authentication, shopping cart, and admin dashboard.",
  ...
  },
  {
    ...
    description:
      "My personal portfolio website showcasing my projects, skills, and experience. Built with React and Material UI.",
